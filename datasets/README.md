...
All 12 staged datasets have completed independent review. Two are conditionally
approved as policy-simulation parameters, four are approved context-only, three
are held for teacher-definition review, and three require Shanghai raw-source
provenance correction. The `processed/` layer remains empty because annual,
definition-compatible preschool-age population and preschool-specific
public-expenditure variables have not yet been established.
