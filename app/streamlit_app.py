...
def _inject_design_system() -> None:
    ...
    st.markdown(
        ...
        :root { --ink:#172b33; --muted:#53666b; --line:#d5ddda; --paper:#fdfdfb; --blue:#3f6577; --softblue:#eef4f3; --green:#35694d; --wood:#a97d50; }
        ...
        .landing-nav { position:sticky; top:0; z-index:10; display:flex; align-items:center; justify-content:space-between; background:#fbfcfc; border:1px solid #dce3e1; border-radius:16px; padding:12px 16px; margin-bottom:28px; box-shadow:0 8px 22px rgba(28,52,58,.07); }
