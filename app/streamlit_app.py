...
def _inject_design_system() -> None:
    ...
    st.markdown(
        ...
        .section { padding:94px 7% 34px; margin:44px 0 22px; border:1px solid #d8d8ce; border-radius:28px; background:linear-gradient(115deg,#fffaf3,#eef4ed); box-shadow:0 14px 36px rgba(83,73,53,.06); } .section-title { font-size:clamp(32px,4vw,54px); line-height:1.05; margin:0 0 16px; max-width:760px; } .section-copy { color:var(--muted); max-width:610px; line-height:1.75; }
        .glass-card { min-height:220px; border:1px solid #d9dfd8; background:#fffdf9; border-radius:20px; padding:25px; box-shadow:0 9px 24px rgba(70,79,58,.07); transition:transform .25s ease,box-shadow .25s ease; } .glass-card:hover { transform:translateY(-4px); box-shadow:0 16px 32px rgba(63,91,72,.12); } .card-icon { font-size:19px; color:#35694d; margin-bottom:42px; } .glass-card h3{font-size:19px;margin:0 0 10px}.glass-card p{font-size:13px;color:#53666b;line-height:1.65;margin:0}
